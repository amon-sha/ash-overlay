...
RDEPEND="
	...
	$(python_gen_cond_dep 'dev-python/configobj[${PYTHON_MULTI_USEDEP}]')
	$(python_gen_cond_dep 'dev-python/pybluez[${PYTHON_MULTI_USEDEP}]')
	$(python_gen_cond_dep '>=dev-python/pygtk-2.0[${PYTHON_MULTI_USEDEP}]')
"
DEPEND=""
