...
F="Arimo,Cousine,Tinos,NotoSans{,Display,Mono},NotoSerif{,Display}"

src_install() {
	mkdir install-unhinted install-hinted || die
	mv unhinted/ttf/{Arimo,Cousine,Tinos,NotoSans{,Display,Mono},NotoSerif{,Display}}/*.tt[fc] install-unhinted/. ||  die
	mv hinted/ttf/{Arimo,Cousine,Tinos,NotoSans{,Display,Mono},NotoSerif{,Display}}/*.tt[fc] install-hinted/. || die
